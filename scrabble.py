# -*- coding: utf-8 -*-
"""
Created on Mon Apr 17 13:18:54 2023
...
"""
#Keeps track of the score of each letter-tile.
#Cannot use a tuple as it uses a tuple of strings eg. ("A", "E", "I", "J") as a single key, which maps to the value 1.
#This means that if you want to retrieve the value associated with any one of those letters, you would need to pass in the 
#entire tuple as the key.
LETTER_VALUES = {"A": 1,
                 "B": 3,
                 "C": 3,
                 "D": 2,
...
class Tile:
    ...
    def __init__(self, letter, letter_values):
        ...
        if self.letter in letter_values:
            self.score = letter_values[self.letter]         #assign scores to letters
...
class Bag:
    ...
    def initialize_bag(self):   
        #Adds the intiial 100 tiles to the bag, the numbers represent the frequency of each letter tile in the bag at the beginning of the game.
...
class Board:
    ...
    def add_premium_squares(self):
        #Adds all of the premium squares that influence the word's score. The coordinates for each type of square are tuples of two integers that represent the row and column positions on the game board.
